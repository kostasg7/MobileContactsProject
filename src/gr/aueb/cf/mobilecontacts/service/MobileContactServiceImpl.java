...
import gr.aueb.cf.mobilecontacts.model.dao.IMobileContactDAO;
...
public class MobileContactServiceImpl implements  IMobileContactService{
    ...
    public MobileContact insertMobileContact(MobileContactInsertDTO dto) throws PhoneNumberAlreadyExistsException {
        ...
        try {
            ...
            System.err.printf("MobileContactService Impl Logger: %s was inserted.\n", mobileContact);
    ...
    public void deleteContactById(Long id) throws ContactNotFoundException {
        try {
            ...
            System.err.printf("MobileContactServiceImpl Logger: contact with id:  was deleted.\n", id);
            dao.deleteById(id);
    ...
    public void deleteByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        try {
            ...
            System.err.printf("MobileContactServiceImpl Logger: contact with phone number:  was deleted.\n", phoneNumber);
